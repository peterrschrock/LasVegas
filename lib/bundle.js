	...
	class Game {
	  ...
	  drawEndGameNotification(){
	    ...
	    if(this.winner === "multiple"){
	      ...
	      this.ctx.fillText(`${this.players[this.winner].name} win with $${this.players[this.winner].money}!`, 535, 315);
	    } else{
	      this.ctx.fillText(`${this.players[this.winner].name} wins with $${this.players[this.winner].money}!`, 535, 315);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	const HumanPlayer = __webpack_require__(8);
	const CPUPlayer = __webpack_require__(9);
